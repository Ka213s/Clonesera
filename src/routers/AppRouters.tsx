  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/instructorhome/list-courses" element={<InstructorLayout><ListCourse /></InstructorLayout>} />
        <Route path="/instructorhome" element={<InstructorLayout><Dashboard /></InstructorLayout>} />
