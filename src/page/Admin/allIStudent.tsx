    ...
    },
    {
      ...
      render: () => (
        <div className="flex space-x-2">
          <Button type="primary" style={{ backgroundColor: '#6A0DAD', borderColor: '#6A0DAD' }} icon={<EditOutlined />} />
          <Button type="primary" danger style={{ backgroundColor: '#6A0DAD', borderColor: '#6A0DAD' }} icon={<DeleteOutlined />} />
        </div>
      )
    }
  ];
