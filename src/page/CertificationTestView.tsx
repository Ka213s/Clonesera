  ...
  return (
    <div className="min-h-screen bg-gray-900 py-8">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-3xl font-semibold text-center mb-8 text-white">Certification Test</h2>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="flex items-center justify-center rounded-full bg-gray-700 p-4">
              <div className="text-center text-gray-400">
                ...
                <p className="text-4xl">{formatTime(duration)}</p>
       ...
       <div className="mt-4">
         <Link
           to="/tests/certification-test-result" // Điều hướng đến trang kết quả
