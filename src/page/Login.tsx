    ...
    try {
      ...
      if (userProfile) {
        ...
        if (existingUser && existingUser.length > 0) {
          if (!existingUser[0].isGoogle) {toast.error('This email is already registered. Please use your password to log in.');
            return;
          }
      ...
      <div className="bg-gray-50 min-h-screen flex items-center justify-center">
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-5xl p-5 items-center">
          <div className='md:w-1/2 px-16'>
            ...
            >
              <Form.Item
                name="email"rules={[{ required: true, message: 'Please input your email!' }, { type: "email", message: 'Format invalid email!' }]}
                >
                  <Input
                    type="text"
                    placeholder='Email'
